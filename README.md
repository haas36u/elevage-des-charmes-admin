# [Elevage des Charmes Admin](https://soft-ui-dashboard-laravel.creative-tim.com/login)
...
Elevage des Charmes Admin comes with dozens of handcrafted UI elements tailored for Bootstrap 5 and an out of the box Laravel backend.
...
Whether you're working on a side project or delivering to a client, we've got you covered. Elevage des Charmes Admin is released under MIT license, so you can use it both for personal and commercial projects for free. All you need to do is start coding.

## Detailed documentation and example pages

We also included detailed documentation for every component and feature so you can follow along. The pre-built example pages give you a quick glimpse of what Elevage des Charmes Admin has to offer so you can get started in no time.
...
The documentation for the Elevage des Charmes Admin is hosted at our [website](https://soft-ui-dashboard-laravel.creative-tim.com/documentation/getting-started/overview.html).
