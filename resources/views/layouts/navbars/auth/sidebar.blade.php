...
>
    <div class="sidenav-header">
        ...
        ></i>
        <a
            class="align-items-center d-flex m-0 navbar-brand text-wrap"
        ...
        >
            <img
                ...
                alt="..."
            />
            <span class="ms-3 font-weight-bold">Elevage des Charmes Admin</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a
                    class="nav-link {{ (Request::is('news-management') ? 'active' : '') }}"
                    href="{{ url('news-management') }}"
                >
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
                    >
                        <i
                            ...
                            class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('news-management') ? 'text-white' : 'text-dark') }} "
                            aria-hidden="true"
                        ></i>
                    </div>
